<footer class="row site-footer">
				...
				<div class="container">
					<div class="row ft">
						...
						<div class="col-sm-12 col-md-3 widget footer-widget widget-about">
							<a href="#" class="foot-logo"><img src="images/logo1.jpg" alt="footer" style="width: 47%;"></a>
			...
			<div class="bottom-footer row m0">
				<div class="container">
					<div class="row">
						Copyright © 2018 by <a href="#">Haintheme</a>. Designed by <a href="#">PukDG</a>. All rights reserved!
					</div>
				</div>
			</div>
		</footer>