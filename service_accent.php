...
<body>
  ...
  <div class="container">
  	<h2 class="h1 page-title">Service Details</h2>
  	<ol class="breadcrumb">
  	...
  	<div class="row car-dt">
  		<div class="col-sm-12 col-md-8 col-xs-12 car-images fleet">
  			<div class="row m0 this-heading">
  				...
  				<h3 class="vehicle-title">Hyundai Accent Sedan <small>(2015-2019 Models)</small></h3>						
    			<!--<h6 class="reviews">
  			...
  			<div class="row m0 this-cover-image">
  				<img src="images/car/accent_long.jpg" alt="" class="this-image">
  		...
  		<div class="col-sm-12 col-md-4 col-xs-12 car-infomations fleet">
  			...
  			<li><span class="icon"><img src="images/icons/car-details/2.png" alt=""></span>Air bags <span class="this-value">03</span></li>
  			...
  			<li><span class="icon"><img src="images/icons/car-details/7.png" alt=""></span>Seats <span class="this-value">4</span></li>
  			<li><span class="icon"><img src="images/icons/car-details/8.png" alt=""></span>Capity <span class="this-value">100 lits</span></li>
  			<li><span class="icon"><img src="images/icons/car-details/9.png" alt=""></span>Product year <span class="this-value">2015</span></li>
  		</ul>
  		<div class="this-footer row m0">
  			<h3 class="rent text-center">1500AED<sub>/Month</sub></h3>
  			<button class="hire-btn"  data-toggle="modal" data-target="#myModal">Book A Car</button>
  		</div>
  		</div>
  	</div>
