  	...
  	<div class="row car-dt">
  		<div class="col-sm-12 col-md-8 col-xs-12 car-images fleet">
  			<div class="row m0 this-heading">
  				...
  				<h3 class="vehicle-title">Toyato Camy Sedan <small>(2015-2019 Models)</small></h3>						
    			<!--<h6 class="reviews">
  			...
  			<div class="row m0 this-cover-image">
  				<img src="images/car/toyota_camy_long.jpg" alt="" class="this-image">
  		...
  		<div class="col-sm-12 col-md-4 col-xs-12 car-infomations fleet">
  			...
  			<li><span class="icon"><img src="images/icons/car-details/9.png" alt=""></span>Product year <span class="this-value">2018</span></li>
  		</ul>
  		<div class="this-footer row m0">
  			<h3 class="rent text-center">220AED<sub>/day</sub></h3>
