  	...
  	<div class="row car-dt">
  		<div class="col-sm-12 col-md-8 col-xs-12 car-images fleet">
  			<div class="row m0 this-heading">
  				...
  				<h3 class="vehicle-title">Hyundai Sonata Sedan <small>(2015-2019 Models)</small></h3>						
    			<!--<h6 class="reviews">
  			...
  			<div class="row m0 this-cover-image">
  				<img src="images/car/sonata_long.jpg" alt="" class="this-image">
  		...
  		<div class="this-footer row m0">
  			<h3 class="rent text-center">70AED<sub>/day</sub></h3>
